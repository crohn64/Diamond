...
class TokenType(Enum):
    ...
    PROGRAM       = 'SOFTWARE'  # marks the beginning of the block
    INTEGER       = 'INTEGER'
    REAL          = 'REAL'
    INTEGER_DIV   = 'DIV'
    VAR           = 'VI'
    PROCEDURE     = 'PROCEDURE'
    BEGIN         = 'START'
    END           = 'FINISH'      # marks the end of the block
    # misc
    ID            = 'ID'
...
def main():
    parser = argparse.ArgumentParser(
        description='Diamond-The next best thing'
    )
    parser.add_argument('inputfile', help='Diamond source file')
    parser.add_argument(
        '--scope',
